...
//single function to print male data.
// function dis(){
//     let rows="";                       
...
//         }
//     }
// document.getElementById("male").innerHTML=rows
// }

// to print all the male,female employees data in two different tables.
function dis(){
    let male="";
    let female="";
    let bigender="";
...
document.getElementById("bigender").innerHTML=bigender;
}